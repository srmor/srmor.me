var Main = React.createClass({displayName: "Main",
  ...
  render: function () {
    return (React.createElement("div", null, 
      React.createElement(Grid, {videos:  this.state.videos, sortFilter:  this.state.sortFilter, tagFilter:  this.state.tagFilter, handleDetailTagClick:  this.handleDetailTagClick}), 
